...
const driverIcon = L.divIcon({
  ...
  html: `
    <div class="relative flex items-center justify-center w-6 h-6">
      ...
      <div class="w-4 h-4 bg-driver rounded-full shadow-[0_0_10px_#22C55E] z-10 border-2 border-[#0F1117]"></div>
    </div>
  `,
  iconSize: [24, 24],
  iconAnchor: [12, 12]
...
const userIcon = L.divIcon({
  ...
  html: `
    <div class="w-5 h-5 bg-yellow-500 rounded-full border-2 border-[#0F1117] shadow-sm flex items-center justify-center">
