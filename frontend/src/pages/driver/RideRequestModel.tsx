...
export const RideRequestModal: React.FC<RideRequestModalProps> = ({ onAccept, onDecline }) => {
  const modalRef = useRef<HTMLDivElement>(null);
  const [timeLeft, setTimeLeft] = useState(15);
  
  // SVG Circle math for the timer
  const radius = 18;
  const circumference = 2 * Math.PI * radius;
  const strokeDashoffset = circumference - (timeLeft / 15) * circumference;

  useEffect(() => {
    // GSAP: Modal scales in with spring ease
    if (modalRef.current) {
      ...
      >
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-sm font-semibold text-primary">Kinetic Luxe</p>
          </div>
        ...
        <div className="relative mb-6 bg-gray-50 rounded-2xl p-4 border border-gray-100">
          ...
          <div className="flex items-start mb-4 relative z-10">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm font-bold text-gray-900">100 Market St</p>
          ...
          <div className="flex items-start relative z-10">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm font-bold text-gray-900">SFO International Airport</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-blue-50/50 rounded-2xl p-4 border border-blue-100">
            ...
            <p className="text-2xl font-bold text-primary">14.2 mi</p>
          </div>
          <div className="bg-blue-50/50 rounded-2xl p-4 border border-blue-100">
        ...
        <div className="flex items-center justify-between mb-6 px-2">
          <div className="flex items-center">
            <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden mr-3">
               <img src="https://i.pravatar.cc/150?img=47" alt="Sarah J." />
            </div>
            <div>
              <p className="font-bold text-gray-900 text-sm">Sarah J. <span className="text-gray-500 font-normal ml-1">4.9 ⭐</span></p>
        ...
        <div className="flex gap-3">
          <Button onClick={onDecline} variant="social" className="w-1/3 rounded-xl bg-gray-100 border-none hover:bg-gray-200 font-bold text-gray-600">
            Decline
          </Button>
          <Button onClick={onAccept} className="w-2/3 rounded-xl font-bold text-lg shadow-md">
            Accept Ride
          </Button>
        </div>
