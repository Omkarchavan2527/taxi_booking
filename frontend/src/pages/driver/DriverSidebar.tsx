      ...
      <div className="p-4 border-t border-[#2A2D3A] bg-[#1A1D27]/50">
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-[#2A2D3A] px-2">
          <div className="flex items-center">
            <img src="https://i.pravatar.cc/150?img=33" alt="Driver" className="w-8 h-8 rounded-full border border-gray-600 mr-3" />
            <div>
              <p className="text-xs font-bold text-white">Michael R.</p>
              <p className="text-[10px] text-gray-400">Toyota Prius</p>
            </div>
          </div>
